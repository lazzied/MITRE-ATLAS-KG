...
class BaseRelationshipClassifier(ABC):
    ...
    @abstractmethod
    def build_graph_context(self, source_id: str, target_id: str | None = None) -> str | None:
        """
    ...
    @abstractmethod
    def process_single_relationship(self, graph_context: str, source_id: str, target_id: str | None = None) -> Any | None:
        """
    ...
    @abstractmethod
    def print_raw_llm_output(self, source_id: str, target_id: str | None = None, classification: Any = None) -> None:
        """
